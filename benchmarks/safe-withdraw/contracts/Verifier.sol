...
contract Verifier {
    ...
    function withdraw(bytes calldata proof, uint256 merkleRoot, uint256 nullifierHash, address recipient, uint256 amount, uint256 chainId, uint256 assetId) external {
        ...
        require(!usedNullifiers[bytes32(nullifierHash)], "nullifier used");
